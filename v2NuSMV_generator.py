...
class moduleinstance:  # Stores the information of the module instances, module types and the ports (calls the class port)
    ...
    def printinfo(self):
        print '> Module instance. Name ' + self.name + ' of type ' \
            + self.moduletype
        print '> Ports found: '
        if self.ports != None:
            for i in self.ports:
...
class module:  # For extracting the information of the information stored in the above classes and trnaslation purposes.
                    ...
                    if self.items != None:
                        ...
                        # found a module instance
                                ...
                                if itemobj.itemvalue.ports != None:
                                    for moduleport in \
    itemobj.itemvalue.ports:
                                        if moduleport.connection \
    != None:
                                            if moduleport.connection \
    == wireobj.name:
                                                connections[wireobj.name] += \
    [(itemobj.itemvalue.name, itemobj.itemvalue.moduletype,
     moduleport.name)]
                if connections != {}:
            ...
            if self.items != None:
                ...
                for itemobj in self.items:
                    ...
                    # found a module instance
                        ...
                        for module_m in itemobj.itemvalue.name:
                            if itemobj.itemvalue.name \
                                not in modules_already_1:
                ...
                for itemobj in self.items:
                    ...
                    # found a module instance
                        ...
                        output_conn = zip(tot_no_modules_1,
                                last_element)
                        ...
                        rem_ports_conn = zip(tot_no_modules_1,
                                rem_ports_1)
    ...
    def printinfo(self):
        ...
        dict1 = {
            ...
            'NOR2_X2': '!(A1|A2)',
            'NOR2_X4': '!(A1|A2)',
            'MUX2_X1': '(!Sin&Ain)|(Sin&Bin)',
            'MUX2_X2': '(!Sin&Ain)|(Sin&Bin)',
            'NAND2_X1': '!(A1 & A2)',
            'NAND2_X2': '!(A1 & A2)',
            'NAND2_X4': '!(A1 & A2)',
            'INV_X1': '!A',
            ...
            'INV_X4': '!A',
            'INV_X8': '!A',
            'OAI22_X1': '!((B1|B2)&(A1|A2))',
            'OAI22_X2': '!((B1|B2)&(A1|A2))',
            'OAI22_X4': '!((B1|B2)&(A1|A2))',
            'AOI21_X1': '!(A|(B1&B2))',
            'OAI21_X1': '!(A&(B1|B2))',
            'OAI21_X2': '!(A&(B1|B2))',
            'OAI21_X4': '!(A&(B1|B2))',
            ...
            'OAI211_X4': '!(A&B&(C1|C2))',
            'AND3_X1': '(A1&A2&A3)',
            'AOI22_X1': '!((A1&A2)|(B1&B2))',
            'XNOR2_X1': '!(A1 xor A2)',
            'XNOR2_X2': '!(A1 xor A2)',
            'NAND4_X1': '!(A1&A2&A3&A4)',
            'NAND4_X2': '!(A1&A2&A3&A4)',
            'NAND4_X4': '!(A1&A2&A3&A4)',
            'AND2_X1': '(A1&A2)',
            'AND2_X2': '(A1&A2)',
            'AND2_X4': '(A1&A2)',
            'AND3_X2': '(A1&A2&A3)',
            ...
            'AOI21_X2': '!(A|(B1&B2))',
            'AOI21_X4': '!(A|(B1&B2))',
            'AOI221_X1': '!(A|(B1&B2)|(C1&C2))',
            'AOI221_X2': '!(A|(B1&B2)|(C1&C2))',
            'AOI221_X4': '!(A|(B1&B2)|(C1&C2))',
            'AOI222_X1': '!((A1&A2)|(B1&B2)|(C1&C2))',
            'AOI222_X2': '!((A1&A2)|(B1&B2)|(C1&C2))',
            'AOI222_X4': '!((A1&A2)|(B1&B2)|(C1&C2))',
            'AOI22_X2': '!((A1&A2)|(B1&B2))',
            'AOI22_X4': '!((A1&A2)|(B1&B2))',
            'BUF_X1': 'A',
            'BUF_X16': 'A',
            'BUF_X2': 'A',
            'BUF_X32': 'A',
            ...
            'NOR4_X2': '!(A1|A2|A3|A4)',
            'NOR4_X4': '!(A1|A2|A3|A4)',
            'OAI221_X1': '!((A&(B1|B2))&(C1|C2))',
            'OAI221_X2': '!((A&(B1|B2))&(C1|C2))',
            'OAI221_X4': '!((A&(B1|B2))&(C1|C2))',
            'OAI222_X1': '!((A1|A2) & (B1|B2) & (C1|C2))',
            'OAI222_X2': '!((A1|A2) & (B1|B2) & (C1|C2))',
            'OAI222_X4': '!((A1|A2) & (B1|B2) & (C1|C2))',
            'OAI33_X1': '!((A1|A2|A3) & (B1|B2|B3))',
            'OR3_X1': '(A1|A2|A3)',
            'OR3_X2': '(A1|A2|A3)',
            'OR3_X4': '(A1|A2|A3)',
            'XOR2_X1': '(A xor B)',
        ...
        dict2 = {
            ...
            'INV_X4': 'A',
            'INV_X8': 'A',
            'OAI22_X1': 'A1,A2,B1,B2',
            'OAI22_X2': 'A1,A2,B1,B2',
            'OAI22_X4': 'A1,A2,B1,B2',
            'AOI21_X1': 'A,B1,B2',
            'OAI21_X1': 'A,B1,B2',
            'OAI21_X2': 'A,B1,B2',
            'OAI21_X4': 'A,B1,B2',
        ...
        for i in range(len(self.tot_modules_1)):
            if self.tot_modules[i] in dict1:
                print "	" + self.tot_modules_1[i] + ': ' \
                    + self.tot_modules[i] + '(' \
                    + ', '.join(self.rem_ports[i]) + ');'
            else:
                print "	" + self.tot_modules_1[i] + ': ' \
                    + self.tot_modules[i] + '(' + self.rem_ports[i][0] \
                    + ');'
        ...
        for i in range(len(self.tot_modules_1)):
            if self.tot_modules[i] in dict1:
                print "	" + self.output[i] + ' := ' \
                    + self.tot_modules_1[i] + '.OUT;'
            else:
                if self.len_port[i] == 3:
                    print "		" + self.output[i] + ' := ' \
                        + self.tot_modules_1[i] + '.Q;'
                elif self.len_port[i] == 4:
                    print "	" + self.indi_ports[i][3] + ' := ' \
                        + self.tot_modules_1[i] + '.QN;'
                    print "	" + self.indi_ports[i][2] + ' := ' \
                        + self.tot_modules_1[i] + '.Q;'
...
tokens = ['unsigned_number', 'simple_identifier',
          'COMMA_list_of_port_declarations_TOKEN', 'escaped_identifier']
    ...
    try:
        ...
        if p[1][0] == 'assign':
            for i in p[1][1]:
                ...
                p[0] = item(itemtype='LISTOFASSIGNS',
                            itemvalue=assignlist)
    except:
        if log:
